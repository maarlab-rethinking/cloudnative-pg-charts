...
![Version: 0.6.1-maarlab.4](https://img.shields.io/badge/Version-0.6.1--maarlab.4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| poolers[].clientTLSSecret                           | [LocalObjectReference][LocalObjectReference] | `{}`                                             | TLS secret used by PgBouncer to accept client connections.                                                                                                                                                                                                                                                                                                                                                                                 |
| poolers[].clientCASecret                            | [LocalObjectReference][LocalObjectReference] | `{}`                                             | Root CA secret used by PgBouncer to validate client certificates.                                                                                                                                                                                                                                                                                                                                                                          |
| poolers[].serverTLSSecret                           | [LocalObjectReference][LocalObjectReference] | `{}`                                             | TLS secret used by PgBouncer when authenticating against PostgreSQL.                                                                                                                                                                                                                                                                                                                                                                       |
| poolers[].serverCASecret                            | [LocalObjectReference][LocalObjectReference] | `{}`                                             | Root CA secret used by PgBouncer to validate PostgreSQL certificates.                                                                                                                                                                                                                                                                                                                                                                      |
